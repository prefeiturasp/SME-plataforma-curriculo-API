...
Se encontrou um bug no plataforma-curriculo você pode reportá-lo usando a ferramenta de
[issues do GitHub](https://github.com/prefeiturasp/SME-plataforma-curriculo-API/issues). Porém antes
...
[criar uma nova issue](https://github.com/prefeiturasp/SME-plataforma-curriculo-API/issues/new). 
...
1. Certifique-se de que sua ideia já não esteja sendo abordada dentro do conjuntos de issues [issues do GitHub](https://github.com/prefeiturasp/SME-plataforma-curriculo-API/issues);
...
Para criar seu pedido de recurso basta
[criar uma nova issue](https://github.com/prefeiturasp/SME-plataforma-curriculo-API/issues/new) usando
o label **recurso**.
/new) usando
o label **recurso**.
...
- Ajude com a documentação do projeto [nossa wiki](https://github.com/prefeiturasp/SME-plataforma-curriculo-API/wiki);
