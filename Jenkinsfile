    ...
    stage('Setup Testes') {
        ...
        steps {
          ...
          script {
	       ...
	       sh 'curl -XPUT -H "Content-Type: application/json" http://loclahost:9200/_cluster/settings -d \'{"transient": { "cluster.routing.allocation.disk.threshold_enabled": false }}\''	     
            } else {
