...
Devise.setup do |config|
  ...
  # config.pepper = 'b64c8aa072605b1a800c95760a19c4d07217a7109a1515b89c96503ed36b5dfa6bfbeca48a8628ea0e09165708698e4de5d3c254043d061a312ce7aa87f6f2f6'
  ...
  config.omniauth :saml,
    ...
    issuer: "#{ENV['SAML_CALLBACK_ADDRESS']}/api/v1/auth/saml/metadata",
    idp_slo_target_url: ENV['SAML_SLO_AUTH_URL'],
    assertion_consumer_service_url: "#{ENV['SAML_CALLBACK_ADDRESS']}/api/v1/auth/saml/callback?resource_class=User",
