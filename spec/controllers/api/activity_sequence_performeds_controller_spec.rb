  ...
  describe 'GET #show_ratings' do
    ...
    context 'logged in users' do
      ...
      it 'get ok response on show ratings specific activity sequence' do
        ...
        get :show_ratings, params: { teacher_id: teacher.id, activity_sequence_slug: activity_sequence.slug }
      ...
      it 'render unauthorized if another teacher' do
        ...
        get :show_ratings, params: { teacher_id: another_teacher.id, activity_sequence_slug: activity_sequence.slug }
