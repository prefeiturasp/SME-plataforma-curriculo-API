...
RSpec.describe Api::V1::ActivitiesController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #update via PATCH' do
      expect(patch: '/api/v1/activities/1').to route_to('api/v1/activities#update', id: '1')
    end

    it 'routes to #destroy' do
      expect(delete: '/api/v1/activities/1').to route_to('api/v1/activities#destroy', id: '1')
    end
  end
end
